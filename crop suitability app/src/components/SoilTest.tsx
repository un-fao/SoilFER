...
export const SoilTest = (props) => {
    ...
    const [sizeQuantityOfMottles, setSizeQuantityOfMottles] = useState<Item>(null);
        ...
        if(sizeQuantityOfMottles){
            if(sizeQuantityOfMottles.value === 0)
                ...
                if(colourDifference === "No" && irregularPatterns === "No")
                    setMottleAbundance("None");
                else if(colourDifference === "Yes" && irregularPatterns === "No" && (mottleSize && mottleSize.name === "Small") && sizeQuantityOfMottles.value <= 2)
                    setMottleAbundance("Low");
                else if(colourDifference === "Yes" && irregularPatterns === "Yes" && (mottleSize && mottleSize.name === "Medium") && sizeQuantityOfMottles.value >= 2)
                    setMottleAbundance("Moderate");
                else if(colourDifference === "Yes" && irregularPatterns === "Yes" && (mottleSize && mottleSize.name === "Large") && sizeQuantityOfMottles.value > 2)
    ...
    function calculateSoil(
        ...
        const mottleFiltered = colourFiltered.filter(
            (entry) =>
                entry.mottleAbundance === mottleAbundance
        );
        const soilAlternateFiltered = soilSummary.filter(
            (entry) =>(
                (entry.DRAINAGE_CLASS === drainage && (entry.minCoarse === coarse ||entry.maxCoarse === coarse) && entry.COLOUR === colour && entry.mottleAbundance === mottleAbundance) ||
                (entry.DRAINAGE_CLASS === drainage && (entry.minCoarse === coarse ||entry.maxCoarse === coarse) && entry.mottleAbundance === mottleAbundance) ||
                ((entry.minCoarse === coarse ||entry.maxCoarse === coarse) && entry.COLOUR === colour && entry.mottleAbundance === mottleAbundance) ||
                (entry.DRAINAGE_CLASS === drainage && entry.COLOUR === colour && entry.mottleAbundance === mottleAbundance) ||
            ...
            if(drainageFiltered.length > 0){
                if(coarseFiltered.length > 0){
                    if(colourFiltered.length > 0){
                        if(mottleFiltered.length > 0){
                            return mottleFiltered;
                        }
    ...
    const processSoil = ()=>{
        let Soil = calculateSoil(soilSummary, resultTexture, drainage, resultCoarseFragments, colour, resultMottleAbundance)[0];
        setSoil(Soil.ID);
    ...
    return(
        <>
            ...
            <div id="CoarseFragmentsTest" style={{ display: 'none', minWidth: '700px' }}>
                <h2 className="m-0 p-0">
                        ...
                        <div className="card p-1 m-0 col-2">
                            <div className="flex flex-row p-0 m-0 gap-1">
                                ...
                                <div key="rocksPebblesGravelNo" className="flex align-items-center">
                                    <RadioButton inputId="rocksPebblesGravelNo" name="rocksPebblesGravel" value="No" onChange={(e: RadioButtonChangeEvent) => {setRocksPebblesGravel(e.value);setCoarseFragments("None");setCoarseFragmentsEntry(true);}} checked={rocksPebblesGravel === "No"} />
            ...
            <div id="MottleAbundanceTest" style={{ display: 'none' }}>
                ...
                <div className="card">
                    ...
                    <div className="flex flex-row p-0 m-0">
                        ...
                        <div className="card p-1 m-0 col-11">
                            ...
                            {sizeQuantityOfMottless.map((category) => {
                                return (
                                    <div key={category.name} className="flex align-items-center w-full">
                                        <RadioButton inputId={category.name} name="sizeQuantityOfMottles" value={category} onChange={(e: RadioButtonChangeEvent) => {setSizeQuantityOfMottles(e.value);calculateMottleAbundance();setMottleAbundanceEntry(true);}} checked={sizeQuantityOfMottles?.value === category.value} />
                                        <label htmlFor={category.name} className="ml-2">{category.name} </label>
                                    </div>
                                );
                            })}
                            ...
                            <div className="card p-1 m-0 col-2">
                                <div className="flex flex-row p-0 m-0 gap-1">
                                    <div key="colourDifferenceYes" className="flex align-items-center">
                                        <RadioButton inputId="colourDifferenceYes" name="colourDifference" value="Yes" onChange={(e: RadioButtonChangeEvent) => {setColourDifference(e.value);calculateMottleAbundance();setMottleAbundanceEntry(true);}} checked={colourDifference === "Yes"} />
                                        <label htmlFor="colourDifferenceYes" className="ml-2">Yes </label>
                                    </div>
                                    <div key="colourDifferenceNo" className="flex align-items-center">
                                        <RadioButton inputId="colourDifferenceNo" name="colourDifference" value="No" onChange={(e: RadioButtonChangeEvent) => {setColourDifference(e.value);calculateMottleAbundance();setMottleAbundanceEntry(true);}} checked={colourDifference === "No"} />
                            ...
                            <div className="card p-1 m-0 col-2">
                                <div className="flex flex-row p-0 m-0 gap-1">
                                    <div key="irregularPatternsYes" className="flex align-items-center">
                                        <RadioButton inputId="irregularPatternsYes" name="irregularPatterns" value="Yes" onChange={(e: RadioButtonChangeEvent) => {setIrregularPatterns(e.value);calculateMottleAbundance();setMottleAbundanceEntry(true);}} checked={irregularPatterns === "Yes"} />
                                        <label htmlFor="irregularPatternsYes" className="ml-2">Yes </label>
                                    </div>
                                    <div key="irregularPatternsNo" className="flex align-items-center">
                                        <RadioButton inputId="irregularPatternsNo" name="irregularPatterns" value="No" onChange={(e: RadioButtonChangeEvent) => {setIrregularPatterns(e.value);calculateMottleAbundance();setMottleAbundanceEntry(true);}} checked={irregularPatterns === "No"} />
                        ...
                        <div className="flex flex-row p-0 m-0">
                            ...
                            <div className="card p-1 m-0 col-11">
                                ...
                                {mottleSizes.map((category) => {
                                    return (
                                        <div key={category.name} className="flex align-items-center w-full">
                                            <RadioButton inputId={category.name} id="mottleSize" name="mottleSize" value={category} onChange={(e: RadioButtonChangeEvent) => {setMottleSize(e.value);setMottleAbundanceEntry(true);}} checked={mottleSize?.value === category.value} />
                                            <label htmlFor={category.name} className="ml-2">{category.name} </label>
                                        </div>
                                    );
                                })}
                ...
                {((sizeQuantityOfMottles && sizeQuantityOfMottles.value == 0) || (sizeQuantityOfMottles && sizeQuantityOfMottles.value > 0 && colourDifference && irregularPatterns && mottleSize)) && <SubmitButton
                        style={{ fontSize: '13pt' }}
                        onClick={()=>{{
                            calculateMottleAbundance();
                            processSoil();
